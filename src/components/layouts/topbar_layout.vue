                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="mt-3 w-2/3 text-center leading-relaxed text-slate-500">
                                    ...
                                    <span class="global-search__keyword font-medium italic"></span> . Please try a different
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    <div class="mt-3.5 flex flex-wrap gap-2">
                                        ...
                                        <a class="flex items-center gap-x-1.5 rounded-full border border-slate-300/70 px-3 py-0.5 hover:bg-slate-50"
                                            ...
                                            <i data-tw-merge="" data-lucide="users2" class="h-4 w-4 stroke-[1.3]"></i> Users
                                        ...
                                        <a class="flex items-center gap-x-1.5 rounded-full border border-slate-300/70 px-3 py-0.5 hover:bg-slate-50"
                                            ...
                                            <i data-tw-merge="" data-lucide="kanban-square"
                                                class="h-4 w-4 stroke-[1.3]"></i> Products
                                    ...
                                    <div class="mt-3.5 flex flex-col gap-1">
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/users/user6-50x50.jpg"
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/users/user4-50x50.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/users/user10-50x50.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                                    ...
                                    <div class="mt-3.5 flex flex-col gap-1">
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/products/product6-400x400.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/products/product3-400x400.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                                        ...
                                        <a class="flex items-center gap-2.5 rounded-md border border-transparent p-1 hover:border-slate-100 hover:bg-slate-50/80"
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/products/product8-400x400.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                ...
                <div class="flex flex-1 items-center">
                    ...
                    <div data-tw-merge="" data-tw-placement="bottom-end" class="dropdown relative ml-5"><button
                            ...
                            class="cursor-pointer image-fit h-[36px] w-[36px] overflow-hidden rounded-full border-[3px] border-white/[0.15]"><img
                                src="assets/dist/images/users/user6-50x50.jpg" alt="Tailwise - Admin Dashboard Template">
                                                ...
                                                <div
                                                    ...
                                                    <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="assets/dist/images/projects/project9-400x400.jpg"
                                                                alt="Tailwise - Admin Dashboard Template">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="assets/dist/images/projects/project8-400x400.jpg"
                                                                alt="Tailwise - Admin Dashboard Template">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="assets/dist/images/projects/project2-400x400.jpg"
                                                                alt="Tailwise - Admin Dashboard Template">
                                                ...
                                                <div
                                                    ...
                                                    <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="assets/dist/images/projects/project3-400x400.jpg"
                                                                alt="Tailwise - Admin Dashboard Template">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="assets/dist/images/projects/project4-400x400.jpg"
                                                                alt="Tailwise - Admin Dashboard Template">
                                    ...
                                    <a class="flex items-center rounded-xl px-3 py-2.5 hover:bg-slate-100/80" href="#">
                                        ...
                                        <div>
                                            ...
                                            <div
                                                ...
                                                <img src="assets/dist/images/users/user7-50x50.jpg"
                                                    alt="Tailwise - Admin Dashboard Template">
                                            ...
                                            <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                                ...
                                                <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="assets/dist/images/projects/project10-400x400.jpg"
                                                            alt="Tailwise - Admin Dashboard Template">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="assets/dist/images/projects/project5-400x400.jpg"
                                                            alt="Tailwise - Admin Dashboard Template">
                                            ...
                                            <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                                ...
                                                <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="assets/dist/images/projects/project6-400x400.jpg"
                                                            alt="Tailwise - Admin Dashboard Template">
                                            ...
                                            <div class="my-3.5 w-40 rounded-[0.6rem] border bg-slate-50/80 p-1 sm:w-56">
                                                ...
                                                <div class="grid grid-cols-3 overflow-hidden rounded-[0.6rem]">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="assets/dist/images/projects/project1-400x400.jpg"
                                                            alt="Tailwise - Admin Dashboard Template">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                    ...
                                    <div
                                        ...
                                        <img src="assets/dist/images/users/user1-50x50.jpg"
                                            alt="Tailwise - Admin Dashboard Template">
                                ...
                                <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                    ...
                                    <div
                                        ...
                                        <img src="assets/dist/images/users/user8-50x50.jpg"
                                            alt="Tailwise - Admin Dashboard Template">
                                ...
                                <div class="flex cursor-pointer items-center rounded-lg px-2.5 py-1 hover:bg-slate-100">
                                    ...
                                    <div
                                        ...
                                        <img src="assets/dist/images/users/user9-50x50.jpg"
                                            alt="Tailwise - Admin Dashboard Template">
